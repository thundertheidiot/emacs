    ...
    inputs.flake-parts.lib.mkFlake { inherit inputs; } {
          ...
          in
          {
            ...
            config = {
              ...
              programs.ewm.emacsPackage =
                mkDefault
                  inputs.self.packages.${pkgs.system}.${config.meowEmacs.package};
            };
          };
      };
      ...
      perSystem =
        ...
        in
        {
          ...
          packages.emacsDebug = import ./nix/package.nix (
            emacsArgs
            // {
              extraCFlags = [
                "-g3"
          ...
          packages.emacsOpt = import ./nix/package.nix (
            emacsArgs
            // {
              extraCFlags = [
                "-march=znver4"
          ...
          packages.emacsIgcOpt = import ./nix/package.nix (
            emacsArgs
            // {
